...
// ── Estilos ───────────────────────────────────────────────────
const s = {
  topbar: { background: '#fff', borderBottom: '0.5px solid #e5e5e3', display: 'flex', alignItems: 'center', gap: 12, padding: '12px 20px', position: 'sticky', top: 0, zIndex: 10 },
  logo: { fontSize: 15, fontWeight: 500 },
  navTabs: { display: 'flex', gap: 4, marginLeft: 'auto' },
  tab: { padding: '6px 14px', borderRadius: 8, fontSize: 13, cursor: 'pointer', border: '0.5px solid transparent', background: 'transparent', color: '#888' },
  tabActive: { padding: '6px 14px', borderRadius: 8, fontSize: 13, cursor: 'pointer', border: '0.5px solid #1B2A4A', background: '#1B2A4A', color: '#fff' },
  ...
  obrasGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 12 },
  ...
  btnPrimary: { padding: '7px 14px', background: '#1B2A4A', color: '#fff', border: 'none', borderRadius: 8, fontSize: 13, cursor: 'pointer' },
  ...
  btnOutline: { padding: '7px 14px', background: 'transparent', color: '#1B2A4A', border: '0.5px solid #1B2A4A', borderRadius: 8, fontSize: 13, cursor: 'pointer' },
  ...
  select: { padding: '7px 10px', border: '0.5px solid #ccc', borderRadius: 8, fontSize: 13, background: '#fff' },
  ...
  modal: { background: '#fff', borderRadius: 12, border: '0.5px solid #ddd', padding: 20, width: 440, maxWidth: '95vw', maxHeight: '90vh', overflowY: 'auto' },
